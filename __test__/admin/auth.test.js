...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Dedrick_Denesik34',
      password: 'RCvYfWWLla42mUL',
      email: 'Isabell31@gmail.com',
      name: 'Miss Ray Larkin',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Research',
      ...
      userType: 720,
      mobileNo: '(349) 297-2779',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 248,
      loginReactiveTime: '2024-04-18T00:29:41.384Z',
      id: '65abf98eaace711d0be7c57f'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Victoria45',
        'password':'6vTRpbf5XMws4jh',
        'email':'Bertrand.Walker41@gmail.com',
        'name':'Jeff Hayes',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Representative',
          'address1':'hack',
          'address2':'synergistic',
          'landmark':'payment',
          'city':'Guyana',
          'isDefault':true,
          'state':'Chief',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Bertrand.Walker41@gmail.com', });
