...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Fritz_Schneider',
      password: 'KDKpAsM4cbyOHnc',
      email: 'Fernando_Haley97@gmail.com',
      name: 'Jesse Hammes',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 939,
      mobileNo: '(896) 569-8159',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 858,
      loginReactiveTime: '2024-01-31T00:57:47.464Z',
      id: '65abf98eaace711d0be7c657'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Grover55',
        'password':'9vsJzBJUHp7vO5H',
        'email':'Torrey42@gmail.com',
        'name':'Franklin Nicolas DDS',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Visionary',
          'address1':'Alaska',
          'address2':'Frozen',
          'landmark':'Intelligent',
          'city':'Infrastructure',
          'isDefault':true,
          'state':'SMTP',
