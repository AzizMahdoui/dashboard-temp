...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Geovanni71',
      password: 'PJa0FSZdM9qi5Ti',
      email: 'Lora23@hotmail.com',
      name: 'Wilson Aufderhar',
      shippingAddress: [
        {
          _id: false,
          pincode: 'port',
          address1: 'Pound',
          address2: 'Buckinghamshire',
          landmark: 'Fish',
          city: 'Car',
          isDefault: true,
          state: 'unleash',
      ...
      userType: 161,
      mobileNo: '(396) 556-8351',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 515,
      loginReactiveTime: '2024-10-21T23:36:31.699Z',
      id: '65abf98eaace711d0be7c5eb'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Tierra17',
        'password':'uXcWibKIfHdeJcc',
        'email':'Sven_Pagac74@yahoo.com',
        'name':'Salvador Konopelski',
        'shippingAddress':[{
          '_id':false,
          'pincode':'functionalities',
          'address1':'microchip',
          'address2':'index',
          'landmark':'lime',
          'city':'Functionality',
          'isDefault':false,
          'state':'frictionless',
          'addressType':'incremental',
          'fullName':'cutting-edge',
          'mobile':768,
          'addressNo':129
        }],
        'wishlist':[{
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Sven_Pagac74@yahoo.com', });
